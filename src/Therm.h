...
class SoundingPoint
{
	public :
		...
		bool   ok ()  {return hpa!=GRIB_NOTDEF && tempC!=GRIB_NOTDEF && dewpC!=GRIB_NOTDEF;}
...
class SoundingPointWind
{
	public :
		...
		bool   ok ()  {return hpa!=GRIB_NOTDEF && vx!=GRIB_NOTDEF && vy!=GRIB_NOTDEF;}
...
class Sounding
{
	public :
		...
		double LI,  SI, KI, TT, SW, CAPE, CIN;
